    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden relative">
            <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-white relative z-10">
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium">Real-time facility load and epidemiological tracking</p>
              </div>
              <button className="text-xs font-bold text-emerald-600 hover:text-emerald-700 uppercase tracking-widest px-4 py-2 bg-emerald-50 rounded-lg transition-colors">
                Open Full Map
              </button>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-indigo-600 to-violet-700 p-6 rounded-3xl shadow-xl text-white relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-lg">NextCare AI Hub</h3>
            </div>
            <p className="text-indigo-50 mb-6 leading-relaxed text-sm">
